...
class Qr_Generator:
    def __init__(self,root):
        ...
        txt_emp_code=Entry(emp_Frame, font =("goudy old style",15),bg="#EDF6E5").place(x=200,y=60)
        txt_name=Entry(emp_Frame, font =("goudy old style",15),bg="#EDF6E5").place(x=200,y=100)
        txt_department=Entry(emp_Frame, font =("goudy old style",15),bg="#EDF6E5").place(x=200,y=140)
        txt_designation=Entry(emp_Frame, font =("goudy old style",15),bg="#EDF6E5").place(x=200,y=180)
        
        
        btn_generator = Button(emp_Frame,text="QR Generator",font=("times new roman",18,'bold'),bg="#0A1931",fg="white").place(x=80,y=250,width=200,height=40)
        btn_clear = Button(emp_Frame,text="Clear",font=("times new roman",18,'bold'),bg="#4C4C6D",fg="white").place(x=290,y=250,width=150,height=40)
        
        self.msg="QR Generated Successfully !!!"
        self.lbl_msg=Label(emp_Frame,text=self.msg,font=("times new roman",15),bg="white",fg="green").place(x=0,y=300,relwidth=1)
